...
#### [문제2]<br>선택적 세트 연산을 적용할 A레지스터가 01001100일 때 상위 4비트를 바꾸기 위한 B레지스터의 값을 적어 주세요. 

#### [문제3]<br>선택적 보수 연산이 쓰이는 이유를 설명해주세요.

#### [문제4]<br>선택적 보수 연산을 적용할 A레지스터가 00111001일 때 모든 비트를 바꾸기 위한 B레지스터의 값을 적어 주세요.
...
#### [문제1]<br>선택적 세트 연산이 쓰이는 이유를 설명해주세요.
-> 선택적 세트는 데이터의 특정 비트들을 1로 세트해주기 위한 동작이며 A레지스터와 대응하는 비트의 위치에 1을 설정하여 OR 연산을 수행합니다.

#### [문제2]<br>선택적 세트 연산을 실행할 A레지스터가 01001100일 때 상위 4비트를 바꾸기 위한 B레지스터의 값을 적어 주세요. 
-> 11110000

#### [문제3]<br>선택적 보수 연산이 쓰이는 이유를 설명해주세요.
-> 데이터 내 특정 비트들의 값을 보수화하기 위한 동작으로 A레지스터와 대응하는 비트의 위치에 1을 설정하여 XOR 연산을 수행합니다.

#### [문제4]<br>선택적 보수 연산을 적용할 A레지스터가 00111001일 때 모든 비트를 바꾸기 위한 B레지스터의 값을 적어 주세요.
-> 1111111

#### [문제5]<br>마스크 연산이 쓰이는 이유를 설명해주세요.
-> 데이터 내 특정 비트들을 0으로 리셋하기 위한 연산으로 A레지스터에 대응하는 비트의 위치에 0을 설정하고 나머지 위치에 1을 설정하여 AND 연산을 수행합니다.
